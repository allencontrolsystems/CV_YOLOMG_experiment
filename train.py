            ...
            if f.exists():
                ...
                if f is best:
                    ...
                    results, _, _ = val.run(data_dict,
                                            ...
                                            iou_thres=0.4 if is_coco else 0.60,  # best pycocotools results at 0.65
                                            single_cls=single_cls,
                                            dataloader=val_loader,
                                            save_dir=save_dir,
                                            save_json=is_coco,
...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='/home/cxl/yolov5/src/yolov5/models/yolov5s.yaml', help='model.yaml path')
    ...
    parser.add_argument('--resume', nargs='?', const=True, default="", help='resume most recent training')
